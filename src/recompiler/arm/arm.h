...
#define CALLFunc(addr) { if (rec_phase) { /*u32 offset=((((u32)(addr) - ((u32)(armPtr) + (8))) >> 2) & 0xFFFFFF);*/ MOV32ItoR(HOST_r9, (u32)addr); write32(BLX(HOST_r9)); } }
#define CALLFuncCC(addr) { if (rec_phase) { /*u32 offset=((((u32)(addr) - ((u32)(armPtr) + (8))) >> 2) & 0xFFFFFF);*/ MOV32ItoR(HOST_r9, (u32)addr); write32(BLXCC(HOST_r9)); } }
#define CALLFuncCS(addr) { if (rec_phase) { /*u32 offset=((((u32)(addr) - ((u32)(armPtr) + (8))) >> 2) & 0xFFFFFF);*/ MOV32ItoR(HOST_r9, (u32)addr); write32(BLXCS(HOST_r9)); } }
